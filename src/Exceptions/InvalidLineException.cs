        ...
        private static string PresetMessage(InvalidLineType lineType){
            ...
            switch(lineType){
                ...
                case InvalidLineType.invalidFormat:
                    message = "Invalid format there is non-enclosed argument. Use '\\' to escape the double quote.";
                break;
                ...
                case InvalidLineType.insufficientArgument:
                    message = "Insufficient argument(s), for the operation you are trying to execute.";
                break;

                case InvalidLineType.nonExistingArguments:
                    message = "Line consists of non-existing argument(s).";
                break;
            }
